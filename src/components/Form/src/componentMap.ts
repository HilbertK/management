...
import MApiSelect from './components/MApiSelect.vue';
...
import JImageCropUpload from './jeecg/components/JImageCropUpload.vue';
...
import JSelectUserByDictItem from './jeecg/components/JSelectUserByDictItem.vue';
...
componentMap.set('MApiSelect', MApiSelect);
...
componentMap.set('JImageCropUpload', JImageCropUpload);
...
componentMap.set('JSelectUserByDictItem', JSelectUserByDictItem);
