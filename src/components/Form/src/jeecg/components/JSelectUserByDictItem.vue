...
<template>
  <div>
    ...
    <UserSelectByDictItemModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" :isRadioSelection="true" />
  </div>
</template>
<script lang="ts">
  import { unref } from 'vue';
  import UserSelectByDictItemModal from './modal/UserSelectByDictItemModal.vue';
  ...
  export default defineComponent({
    name: 'JSelectUserByDictItem',
    components: {
      UserSelectByDictItemModal,
      JSelectBiz,
    },
    inheritAttrs: false,
    props: {
